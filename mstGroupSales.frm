...
Begin VB.Form mstGroupSales 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGroupSales.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGroupSales.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGroupSales.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGroupSales.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGroupSales.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGroupSales.frx":07A6
      End
   End
End
Attribute VB_Name = "mstGroupSales"
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    ...
    objData.Update GetDSN, "groupsales", "kode= '" & cKode.Text & "'", vaField, vaValue
    getSQL
    initvalue
    GetEdit False
   Else
...
Dim n As Single
  ...
  Set dbData = objData.Browse(GetDSN, "groupsales", , , , , , "kode")
