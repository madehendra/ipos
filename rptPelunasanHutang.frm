...
Begin VB.Form rptPelunasanHutang 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports tdb 
         ...
         Sections(0).Cells(2).Exp=   """PELUNASAN HUTANG"""
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPelunasanHutang.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPelunasanHutang.frx":00A6
      End
   End
End
Attribute VB_Name = "rptPelunasanHutang"
...
Private Sub cSupplier_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "supplier", "kodesupplier,nama,alamat", "nama", sisContent, cSupplier.Text)
...
Dim nTotal As Double
  ...
  End If
  cSQL = "SELECT p.nomorpelunasanhutang,p.nomorpembelian,p.hutang,p.discount,p.pelunasan,"
  cSQL = cSQL & " t.tgl,t.discount as totaldiscount,t.total,t.pelunasan as totalpelunasan,"
  cSQL = cSQL & " t.kodesupplier,r.nama as namasupplier,"
  cSQL = cSQL & " b.jthtmp"
  cSQL = cSQL & " From pelunasanhutang p"
  cSQL = cSQL & " LEFT JOIN totpelunasanhutang t on t.nomorpelunasanhutang = p.nomorpelunasanhutang"
  cSQL = cSQL & " LEFT JOIN totpembelian b on b.nomorpembelian = p.nomorpembelian"
  ...
  cSQL = cSQL & " ORDER BY p.nomorpelunasanhutang"
  ...
  If Not dbData.EOF Then
    ...
    Do While Not dbData.EOF
      ...
      vaArray(n, 0) = (dbData!nomorpelunasanhutang)
      vaArray(n, 1) = (dbData!namasupplier)
      vaArray(n, 2) = Format(dbData!tgl, "dd-MM-yyyy")
      vaArray(n, 3) = (dbData!nomorpembelian)
      vaArray(n, 4) = (dbData!tgl)
      vaArray(n, 5) = (dbData!hutang)
...
Dim cSQL As String
  ...
  cSQL = cSQL & " FROM totpelunasanhutang"
