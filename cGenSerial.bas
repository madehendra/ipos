...
Public Function GetBIOSName() As String
  GetBIOSName = ""
  Set colProcessList = GetObject("Winmgmts:").ExecQuery("SELECT SerialNumber FROM Win32_BIOS")
  For Each objprocess In colProcessList
      GetBIOSName = objprocess.SerialNumber
  Next
End Function

Public Function GetProcessorName() As String
  GetProcessorName = ""
  Set colProcessList = GetObject("Winmgmts:").ExecQuery("SELECT DeviceID FROM Win32_Processor")
  For Each objprocess In colProcessList
    GetProcessorName = objprocess.DeviceID
  Next
'  DiskDrive
End Function

Public Function GetDiskName() As String
  GetDiskName = ""
  Set colProcessList = GetObject("Winmgmts:").ExecQuery("SELECT MACAddress FROM Win32_NetworkAdapter")
  For Each objprocess In colProcessList
    GetDiskName = objprocess.MACAddress
  Next
End Function
