...
Begin VB.Form mstKategori 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstKategori.frx":07A6
      End
   End
End
Attribute VB_Name = "mstKategori"
...
Dim cInfo As String
  ...
  If Trim(cKode.Text) <> "" Then
    If MsgBox("Data benar-benar dihapus...?" & vbCrLf & vbCrLf & cInfo, vbExclamation + vbYesNo) = vbYes Then
      If Not lExist(objData, "stock", "kategori", cKode.Text) Then
        objData.Delete GetDSN, "kategori", "kategori", sisAssign, cKode.Text
      Else
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    vaField = Array("kategori", "keterangan")
    vaValue = Array(cKode.Text, cKeterangan.Text)
    objData.Update GetDSN, "kategori", "kategori = '" & cKode.Text & "'", vaField, vaValue
    getSQL
    initvalue
    GetEdit False
   Else
...
Private Function ValidSaving() As Boolean
  ...
  Else
    If InStr(cKode.Text, " ") > 0 Then
      ValidSaving = False
      MsgBox "karakter SPASI tidak diijinkan", vbExclamation
      Exit Function
    End If
  End If
End Function
...
Dim n As Single
  ...
  Set dbData = objData.Browse(GetDSN, "kategori", , , , , , "kategori")
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      vaArray.InsertRows vaArray.UpperBound(1) + 1
      n = vaArray.UpperBound(1)
      vaArray(n, 0) = GetNull(dbData!kategori, "")
