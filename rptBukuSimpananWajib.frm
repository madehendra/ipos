...
Begin VB.Form rptBukuSimpananWajib 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Buku Simpanan Wajib"
   ClientHeight    =   5640
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   11760
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
         ...
         _StyleDefs(11)  =   ":id=4,.fontname=Tahoma"
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptBukuSimpananWajib.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptBukuSimpananWajib.frx":00A6
      End
      Begin BiSAButtonProject.BiSAButton cmdRefresh 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptBukuSimpananWajib.frx":032C
      End
   End
End
Attribute VB_Name = "rptBukuSimpananWajib"
...
Private Sub cKodeAnggota_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "anggota", "kodeanggota,nama,kodedep", "kodeanggota", sisContent, cKodeAnggota.Text, , "kodeanggota")
  If Not dbData.EOF Then
    cKodeAnggota.Text = cKodeAnggota.Browse(dbData, Array("Kode", "Nama", "Dep"), , Array(15, 20, 25))
...
Private Sub cNama_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "anggota", "nama,kodeanggota,kodedep", "nama", sisContent, cNama.Text, , "nama")
  If Not dbData.EOF Then
    cNama.Text = cNama.Browse(dbData, Array("Nama", "Kode", "Dep"), , Array(20, 15, 25))
    cAlamat.Text = GetNull(dbData!kodedep)
...
Dim nKredit As Double
  ...
  xarray(0, 3) = "SALDO PER " & Format(dAwal.Value - 1, "dd/MM/yy")
  xarray(0, 6) = 0
  
  Set dbData = objData.Browse(GetDSN, "simpananwajib", , "tgl", sisLTEqual, Format(dAkhir.Value, "yyyy-mm-dd"), " and kodeanggota = '" & cKodeAnggota.Text & "'", "tgl,kodeanggota")
  If Not dbData.EOF Then
    dbData.MoveFirst
    Do While Not dbData.EOF
      ...
      Else
        n = n + 1
        xarray.InsertRows n
        xarray(n, 0) = Format((dbData!tgl), "dd/MM/yy")
        xarray(n, 1) = GetNull(dbData!nomorsimpananwajib)
        xarray(n, 2) = ""
        xarray(n, 3) = "Simpanan wajib"
...
Private Sub Rpt()
  With FrmRPT
    .AddPageHeader UCase("Buku SIMPANAN Wajib"), tdbHalignCenter, , , , , 10, True
    .AddPageHeader UCase(aCfg(objData, msNamaPerusahaan)), tdbHalignCenter, , , True, , 12, True
    .AddPageHeader "Antara Tanggal : " & Format(dAwal.Value, "dd-MM-yyyy") & " s.d " & Format(dAkhir.Value, "dd-MM-yyyy"), tdbHalignCenter, , , True, , 10, True
    .AddPageHeader " ", , , , True
    .AddPageHeader " ", , , , True
    
    .AddPageHeader "Nama Anggota", tdbHalignLeft, , 15, , , , , , True, , tdbPageHeaderSect
    .AddPageHeader ": " & cNama.Text
    .AddPageHeader "Kode Anggota", tdbHalignLeft, , 15, True, , , , , True, , tdbPageHeaderSect
    .AddPageHeader ": " & cKodeAnggota.Text
    .AddPageHeader "Dep", tdbHalignLeft, , 15, True, , , , , True, , tdbPageHeaderSect
