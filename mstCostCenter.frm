...
Begin VB.Form mstCostCenter 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Setup Cost Center ..."
   ClientHeight    =   5535
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   7350
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstCostCenter.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstCostCenter.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstCostCenter.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstCostCenter.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstCostCenter.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstCostCenter.frx":07A6
      End
   End
   ...
   End
End
Attribute VB_Name = "mstCostCenter"
...
Dim dbcostcenter As New ADODB.Recordset
...
Dim cInfo As String
  ...
  If MsgBox("Data Benar-benar dihapus ?" & vbCrLf & vbCrLf & cInfo, vbQuestion + vbYesNo) = vbYes Then
    If lExist(objData, "bukubesar", "kodecostcenter", GetKode) Then
      MsgBox "Maaf, data masih digunakan dalam sistem" & vbCrLf & "Data tidak bisa dihapus"
      InitDel
      Exit Sub
    End If
    If lExist(objData, "config", "keterangan", GetKode) Then
      ...
      Exit Sub
    End If
    objData.Delete GetDSN, "costcenter", "kodecostcenter", sisAssign, GetKode
  End If
  InitDel
End Sub
...
Private Sub cKode_Validate(Cancel As Boolean)
  Set dbData = objData.Browse(GetDSN, "costcenter", , "kodecostcenter", sisAssign, GetKode)
...
Dim vaValue
  ...
  If ValidSaving() Then
    ...
    vaField = Array("kodecostcenter", "keterangan")
    vaValue = Array(GetKode, cNama.Text)
    objData.Update GetDSN, "costcenter", "kodecostcenter = '" & GetKode & "'", vaField, vaValue
    objData.Save GetDSN
    InitValue
    GetEdit False
  End If
...
Dim n As Integer
  ...
  Set dbData = objData.Browse(GetDSN, "costcenter", "kodecostcenter,keterangan", "kodecostcenter", sisContent, TDBGrid1.Columns(1).FilterText, " and keterangan LIKE '%" & TDBGrid1.Columns(2).FilterText & "%'")
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      vaArray.InsertRows vaArray.UpperBound(1) + 1
      n = vaArray.UpperBound(1)
      vaArray(n, 0) = n
      vaArray(n, 1) = GetNull(dbData!kodecostcenter)
...
Dim db As New ADODB.Recordset
  ...
  Set db = objData.Browse(GetDSN, "costcenter", , "kodecostcenter", sisAssign, TDBGrid1.Columns(1).Text)
  If Not db.EOF Then
    cKode.Text = GetNull(db!kodecostcenter)
