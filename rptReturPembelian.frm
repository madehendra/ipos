...
Begin VB.Form rptReturPembelian 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports tdb 
         ...
         Sections(0).Cells(2).Exp=   """RETUR PEMBELIAN"""
         ...
         Sections(1).Cells(2).Exp=   """SUPPLIER"""
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptReturPembelian.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptReturPembelian.frx":00A6
      End
   End
End
Attribute VB_Name = "rptReturPembelian"
...
Dim nTotal As Double
  ...
  If Check1.Value = 1 Then
    cFilter = " AND t.kodesupplier = '" & cSupplier.Text & "'"
  End If
  
  If Option1(0).Value = True Then
    cFilterPosting = " and t.flag_posting = 1"
  End If
  If Option1(1).Value = True Then
    cFilterPosting = " and t.flag_posting = 0"
  End If
  
  cSQL = "SELECT p.nomorreturpembelian,p.kodesatuan,p.kodestock,p.qty,p.harga,p.discount as disc,p.jumlah,"
  cSQL = cSQL & " t.tgl,t.subtotal,t.discount,t.pajak,t.total,"
  cSQL = cSQL & " t.kodesupplier,s.nama as namabarang,r.nama as namasupplier"
  cSQL = cSQL & " From returpembelian p"
  cSQL = cSQL & " LEFT JOIN totrtnpembelian t on t.nomorreturpembelian = p.nomorreturpembelian"
  cSQL = cSQL & " LEFT JOIN stock s on s.kodestock = p.kodestock"
  cSQL = cSQL & " LEFT JOIN supplier r on r.kodesupplier = t.kodesupplier"
  cSQL = cSQL & " WHERE p.tgl >='" & Format(dDate(0).Value, "yyyy-MM-dd") & "'"
  cSQL = cSQL & " AND p.tgl <='" & Format(dDate(1).Value, "yyyy-MM-dd") & "'" & cFilter & cFilterPosting
  cSQL = cSQL & " ORDER BY p.nomorreturpembelian"
  ...
  If Not dbData.EOF Then
    ...
    Do While Not dbData.EOF
      ...
      vaArray(n, 0) = (dbData!nomorreturpembelian)
      vaArray(n, 1) = (dbData!namasupplier)
