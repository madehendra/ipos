...
Begin VB.Form rptDaftarCustomer 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptDaftarCustomer.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptDaftarCustomer.frx":00A6
      End
   End
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(15)=   "Column(2).Width=2672"
      Splits(0)._ColumnProps(16)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(17)=   "Column(2)._WidthInPix=2593"
      ...
      Splits(0)._ColumnProps(21)=   "Column(3).Width=9313"
      Splits(0)._ColumnProps(22)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(23)=   "Column(3)._WidthInPix=9234"
      Splits(0)._ColumnProps(24)=   "Column(3)._EditAlways=0"
      Splits(0)._ColumnProps(25)=   "Column(3)._ColStyle=512"
      Splits(0)._ColumnProps(26)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(27)=   "Column(4).Width=6403"
      Splits(0)._ColumnProps(28)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(29)=   "Column(4)._WidthInPix=6324"
      ...
      _StyleDefs(40)  =   "Splits(0).Columns(2).Style:id=28,.parent=13,.alignment=0"
      ...
      _StyleDefs(44)  =   "Splits(0).Columns(3).Style:id=54,.parent=13,.alignment=0"
      ...
      _StyleDefs(48)  =   "Splits(0).Columns(4).Style:id=32,.parent=13,.alignment=0"
   ...
   End
End
Attribute VB_Name = "rptDaftarCustomer"
...
Dim n As Integer
  ...
  Set dbData = objData.Browse(GetDSN, "anggota a", "a.kodeanggota,a.nama,a.kodedep,d.keterangan,a.alamat,a.telp", "a.kodeanggota", sisContent, TDBGrid1.Columns(0).FilterText, " and a.nama LIKE '%" & TDBGrid1.Columns(1).FilterText & "%' AND d.keterangan LIKE '%" & TDBGrid1.Columns(2).FilterText & "%'", "a.kodedep,d.keterangan", Array("left join dep d on d.kodedep = a.kodedep"))
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      ...
      vaArray(n, 5) = GetNull(dbData!alamat)
      vaArray(n, 6) = GetNull(dbData!telp)
      dbData.MoveNext
    Loop
...
Private Sub cmdPreview_Click()
   With FrmRPT
    .AddPageHeader UCase("Daftar Member"), tdbHalignCenter, , , True, dbArial, 12, True, , , False
    ...
    .AddTableHeader "DEPT", , , , 15
    .AddTableHeader "ALAMAT"
    .AddTableHeader "TELP", , , , 20
