...
Begin VB.Form frmKeteranganBayar 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Keterangan Bayar"
   ClientHeight    =   4920
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   6675
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmKeteranganBayar.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmKeteranganBayar.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmKeteranganBayar.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmKeteranganBayar.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmKeteranganBayar.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmKeteranganBayar.frx":07A6
      End
   End
End
Attribute VB_Name = "frmKeteranganBayar"
...
Dim cInfo As String
  ...
  If Trim(cKode.Text) <> "" Then
    If MsgBox("Data benar-benar dihapus...?" & vbCrLf & vbCrLf & cInfo, vbExclamation + vbYesNo) = vbYes Then
      If Not lExist(objData, "totpenjualan", "kodegroupsales", cKode.Text) Then
        objData.Delete GetDSN, "groupsales", "kode", sisAssign, cKode.Text
      Else
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    ...
    objData.Update GetDSN, "keteranganbayar", "kode= '" & cKode.Text & "'", vaField, vaValue
    getSQL
    initvalue
    GetEdit False
   Else
...
Dim n As Single
  ...
  Set dbData = objData.Browse(GetDSN, "keteranganbayar", , , , , , "kode")
