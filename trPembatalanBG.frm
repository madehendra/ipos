...
Begin VB.Form trPembatalanBG 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pembatalan BG/Cek"
   ClientHeight    =   6405
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   11925
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame4 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPembatalanBG.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPembatalanBG.frx":00A6
      End
   End
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(5).Caption=   "TGL PENCAIRAN"
      Columns(5).DataField=   ""
   ...
   End
End
Attribute VB_Name = "trPembatalanBG"
  ...
  objData.Start GetDSN
    For n = vaArray.LowerBound(1) To vaArray.UpperBound(1)
      If vaArray(n, 0) = -1 Then
        ...
        'hapus di bukubesar
        lSave = IIf(lSave, DelKodeTr(objData, msPencairanBG, vaArray(n, 3)), False)
...
Dim cSQL As String
  ...
  If chkJatuhTempo.Value = 1 Then
    cSQL = cSQL & " and b.date = '" & Format(dJatuhTempo.Value, "yyyy-MM-dd") & "'"
  End If
  If chkMember.Value = 1 Then
    cSQL = cSQL & " and a.kodeanggota = '" & cMember.Text & "'"
  End If
  Set db = objData.Browse(GetDSN, "pencairanbg b", "g.reff,g.jumlah,b.nomorpelunasanpiutang,a.nama,b.tableid,b.date,b.kodeakun,b.keterangan", , , , cSQL, , Array("left join totpelunasanpiutang t on t.nomorpelunasanpiutang = b.nomorpelunasanpiutang", "left join anggota a on a.kodeanggota = t.kodeanggota", "left join bg g on g.tableid = b.tableid"))
  If Not db.EOF Then
    Do While Not db.EOF
      ...
      vaArray(n, 5) = Format(GetNull(db!Date), "dd-MM-yyyy")
      vaArray(n, 6) = GetNull(db!kodeakun)
      vaArray(n, 7) = GetNull(db!keterangan)
