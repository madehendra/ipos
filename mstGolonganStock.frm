...
Begin VB.Form mstGolonganStock 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "GOLONGAN INVENTORY"
   ClientHeight    =   6345
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   6690
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid1 
         ...
         Columns(0).DataField=   "kodegolonganstock"
         ...
         _StyleDefs(30)  =   "Splits(0).HeadingStyle:id=14,.parent=2,.alignment=2,.bold=0,.fontsize=825"
         _StyleDefs(31)  =   ":id=14,.italic=0,.underline=0,.strikethrough=0,.charset=0"
         _StyleDefs(32)  =   ":id=14,.fontname=Verdana"
         ...
         _StyleDefs(46)  =   "Splits(0).Columns(1).Style:id=46,.parent=13"
         ...
         _StyleDefs(54)  =   ":id=34,.wraptext=-1,.bold=-1,.fontsize=975,.italic=0,.underline=0"
         _StyleDefs(55)  =   ":id=34,.strikethrough=0,.charset=0"
         _StyleDefs(56)  =   ":id=34,.fontname=Times New Roman"
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGolonganStock.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGolonganStock.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGolonganStock.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGolonganStock.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGolonganStock.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstGolonganStock.frx":07A6
      End
   End
End
Attribute VB_Name = "mstGolonganStock"
...
Private Sub cKode_GotFocus()
  cKode.SelStart = 0
  cKode.SelLength = cKode.MaxLength
End Sub
...
Dim cInfo As String
  ...
  If Trim(KodeRegex) <> "" Then
    If MsgBox("Data benar-benar dihapus...?" & vbCrLf & vbCrLf & cInfo, vbExclamation + vbYesNo) = vbYes Then
      If Not lExist(objData, "stock", "kodegolongan", Trim(GetInduk(cKode.Text))) Then
        objData.Delete GetDSN, "golongan", "kodegolongan", sisAssign, GetInduk(cKode.Text, False)
      Else
        MsgBox "Maaf record ini masih digunakan oleh sistem" & vbCrLf & "Data tidak bisa dihapus"
      End If
    End If
    InitValue
    getSQL
...
Private Sub cmdSimpan_Click()
  ...
  If ValidSaving() Then
    ...
    vaValue = Array(GetInduk(cKode.Text, False), cKeterangan.Text)
    objData.Update GetDSN, "golongan", "kodegolongan = '" & GetInduk(cKode.Text, False) & "'", vaField, vaValue
    objData.Save GetDSN
    getSQL
    InitValue
    GetEdit False
...
Private Function KodeRegex() As String
Dim cTmpKode

  cTmpKode = Replace(cKode.Text, ".", "")
  KodeRegex = Replace(cTmpKode, " ", "")
End Function
...
Private Function ValidSaving() As Boolean
  ...
  If Len(KodeRegex) = 3 Or Len(KodeRegex) = 6 Or Len(KodeRegex) > 6 Then
    ValidSaving = True
  Else
    MsgBox "Kode Golongan Inventory tidak sah, Penyimpanan dibatalkan!"
    ValidSaving = False
    cKode.SetFocus
    Exit Function
  End If
...
Private Sub GetMemory()
  cKode.Text = GetDetail(DataGrid1.Columns(0).Text, "999.999.999", 1)
...
Dim n As Single
  ...
  Set dbData = objData.Browse(GetDSN, "golongan", "kodegolongan,keterangan", , , , , "kodegolongan")
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      vaArray.InsertRows vaArray.UpperBound(1) + 1
      n = vaArray.UpperBound(1)
      vaArray(n, 0) = GetNull(dbData!kodegolongan, "")
      vaArray(n, 1) = Space(Len(GetNull(vaArray(n, 0))) - 3) & " " & GetNull(dbData!keterangan)
      dbData.MoveNext
    Loop
  End If
