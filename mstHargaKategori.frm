...
Begin VB.Form mstHargaKategori 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Setup Harga Kategori"
   ClientHeight    =   6465
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   9180
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin BiSATextBoxProject.BiSABrowse cKodeGudang 
         ...
         EndProperty
      End
      Begin BiSANumberBoxProject.BiSANumberBox nDiskon 
         Height          =   330
         Left            =   1095
         TabIndex        =   9
         Top             =   1350
      ...
      Begin BiSANumberBoxProject.BiSANumberBox nMarkUp 
         ...
         EndProperty
      End
      Begin BiSANumberBoxProject.BiSANumberBox nMarkDown 
         Height          =   330
         Left            =   1095
         TabIndex        =   11
         Top             =   2070
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid1 
         ...
         Columns(1).Caption=   "Kategori"
         Columns(1).DataField=   "Kode"
         ...
         Columns(3).Caption=   "Diskon"
         Columns(3).DataField=   ""
         Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(4)._VlistStyle=   0
         Columns(4)._MaxComboItems=   5
         Columns(4).Caption=   "Mark Up"
         Columns(4).DataField=   ""
         Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(5)._VlistStyle=   0
         Columns(5)._MaxComboItems=   5
         Columns(5).Caption=   "Mark Down"
         Columns(5).DataField=   ""
         ...
         Splits(0)._ColumnProps(25)=   "Column(4).Width=2566"
         Splits(0)._ColumnProps(26)=   "Column(4).DividerColor=0"
         Splits(0)._ColumnProps(27)=   "Column(4)._WidthInPix=2487"
         ...
         _StyleDefs(40)  =   "Splits(0).Columns(0).Style:id=58,.parent=13"
         _StyleDefs(41)  =   "Splits(0).Columns(0).HeadingStyle:id=55,.parent=14"
         _StyleDefs(42)  =   "Splits(0).Columns(0).FooterStyle:id=56,.parent=15"
         _StyleDefs(43)  =   "Splits(0).Columns(0).EditorStyle:id=57,.parent=17"
         ...
         _StyleDefs(52)  =   "Splits(0).Columns(3).Style:id=32,.parent=13,.alignment=1"
         _StyleDefs(53)  =   "Splits(0).Columns(3).HeadingStyle:id=29,.parent=14"
         _StyleDefs(54)  =   "Splits(0).Columns(3).FooterStyle:id=30,.parent=15"
         _StyleDefs(55)  =   "Splits(0).Columns(3).EditorStyle:id=31,.parent=17"
         ...
         _StyleDefs(68)  =   ":id=34,.wraptext=-1,.bold=-1,.fontsize=975,.italic=0,.underline=0"
         _StyleDefs(69)  =   ":id=34,.strikethrough=0,.charset=0"
         _StyleDefs(70)  =   ":id=34,.fontname=Times New Roman"
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstHargaKategori.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstHargaKategori.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstHargaKategori.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstHargaKategori.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstHargaKategori.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstHargaKategori.frx":07A6
      End
   End
End
Attribute VB_Name = "mstHargaKategori"
...
Private Sub cKategori_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "kategori", "kategori,keterangan", "kategori", sisContent, cKategori.Text, , "kategori,keterangan")
...
Private Sub cKodeGudang_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "gudang", "kodegudang,keterangan", "kodegudang", sisContent, cKodeGudang.Text, , "kodegudang,keterangan")
  If Not dbData.EOF Then
    If dbData.RecordCount > 1 Then
      cKodeGudang.Text = cKategori.Browse(dbData)
    End If
...
Dim cInfo As String
  ...
  cInfo = "Kode: " & cKategori.Text & vbCrLf
  cInfo = cInfo & "Keterangan: " & cKodeGudang.Text & vbCrLf

  If Trim(cKode.Text) <> "" Then
    If MsgBox("Data benar-benar dihapus...?" & vbCrLf & vbCrLf & cInfo, vbExclamation + vbYesNo) = vbYes Then
      objData.Delete GetDSN, "kelompokharga", "id", sisAssign, cKode.Text
    End If
    initvalue
    getSQL
  End If
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    vaField = Array("kategori", "kodegudang", "diskon", "markup", "markdown")
    vaValue = Array(cKategori.Text, cKodeGudang.Text, nDiskon.Value, nMarkUp.Value, nMarkDown.Value)
    objData.Update GetDSN, "kelompokharga", "kategori = '" & cKategori.Text & "' and kodegudang = '" & cKodeGudang.Text & "'", vaField, vaValue
    getSQL
    initvalue
    GetEdit False
   Else
...
Private Function ValidSaving() As Boolean
  ...
  ValidSaving = True
  If Trim(cKategori.Text) = "" Then
    ValidSaving = False
    cKategori.SetFocus
    Exit Function
  End If
  If Trim(cKodeGudang.Text) = "" Then
    ValidSaving = False
...
Private Sub GetMemory()
  ...
  cKategori.Text = Trim(DataGrid1.Columns(1).Text)
  cKodeGudang.Text = Trim(DataGrid1.Columns(2).Text)
  nDiskon.Value = Trim(DataGrid1.Columns(3).Value)
  nMarkUp.Value = Trim(DataGrid1.Columns(4).Value)
  nMarkDown.Value = Trim(DataGrid1.Columns(5).Value)
End Sub
...
Dim n As Single
  ...
  Set dbData = objData.Browse(GetDSN, "kelompokharga", , , , , , "id")
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      vaArray.InsertRows vaArray.UpperBound(1) + 1
      n = vaArray.UpperBound(1)
      vaArray(n, 0) = GetNull(dbData!Id)
      vaArray(n, 1) = GetNull(dbData!kategori)
      vaArray(n, 2) = GetNull(dbData!kodegudang)
      vaArray(n, 3) = GetNull(dbData!diskon)
      vaArray(n, 4) = GetNull(dbData!MarkUp)
      vaArray(n, 5) = GetNull(dbData!MarkDown)
      dbData.MoveNext
    Loop
  End If
