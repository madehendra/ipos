...
Begin VB.Form rptPembatalanKasir 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "PEMBATALAN KASIR"
   ClientHeight    =   1815
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   6990
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports tdb 
         ...
         Sections(0).Cells(2).Exp=   """LAPORAN PEMBATALAN PENJUALAN KASIR"""
         ...
         Sections(5).Cells(5).Exp=   """SUB TOTAL PEMBATALAN KASIR (Rp)"""
         ...
         Sections(5).Cells(14).Exp=   """TOTAL PEMBATALAN"""
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPembatalanKasir.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPembatalanKasir.frx":00A6
      End
   End
End
Attribute VB_Name = "rptPembatalanKasir"
...
Dim nQty As Double
  ...
  cSQL = "SELECT p.nomorkasir,p.kodestock,p.qty,s.kodesatuan,p.harga,p.jumlah,"
  cSQL = cSQL & " t.tgl,t.subtotal,t.discount,t.total,t.username,"
  cSQL = cSQL & " s.nama as namabarang"
  cSQL = cSQL & " FROM batalkasir p"
  cSQL = cSQL & " LEFT JOIN totbatalkasir t on t.nomorkasir = p.nomorkasir"
