...
Begin VB.Form mstNewGolongan 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Master Golongan Stock"
   ClientHeight    =   5175
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   6675
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin BiSATextBoxProject.BiSATextBox cKeterangan 
         ...
         EndProperty
      End
      Begin BiSATextBoxProject.BiSABrowse cGroupHarga 
         Height          =   330
         Left            =   120
         TabIndex        =   9
         Top             =   960
         ...
         EndProperty
      End
      Begin BiSATextBoxProject.BiSATextBox cKodeGroupHarga 
         Height          =   330
         Left            =   3765
         TabIndex        =   10
         Top             =   945
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstNewGolongan.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstNewGolongan.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstNewGolongan.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstNewGolongan.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstNewGolongan.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "mstNewGolongan.frx":07A6
      End
   End
End
Attribute VB_Name = "mstNewGolongan"
...
Private Sub cGroupHarga_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "kelompokharga", "id,kategori,kodegudang,diskon", "kategori", sisContent, cGroupHarga.Text, " or id like '%" & cGroupHarga.Text & "%'", "kategori")
  cGroupHarga.Text = cGroupHarga.Browse(dbData, Array("ID", "KATEGORI", "GUDANG", "DISKON"), , Array(5, 15, 15, 10))
  If Not dbData.EOF Then
    cGroupHarga.Text = GetNull(dbData!kategori)
    cKodeGroupHarga.Text = GetNull(dbData!Id)
  End If
End Sub
...
Dim cInfo As String
  ...
  If Trim(cKode.Text) <> "" Then
    If MsgBox("Data benar-benar dihapus...?" & vbCrLf & vbCrLf & cInfo, vbExclamation + vbYesNo) = vbYes Then
      If Not lExist(objData, "stock", "kodegolongan", cKode.Text) Then
        objData.Delete GetDSN, "golongan", "kodegolongan", sisAssign, cKode.Text
      Else
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    ...
    objData.Update GetDSN, "golongan", "kodegolongan = '" & cKode.Text & "'", vaField, vaValue
    getSQL
    initvalue
    GetEdit False
   Else
...
Dim n As Single
  ...
  Set dbData = objData.Browse(GetDSN, "golongan", , , , , , "kodegolongan")
  If Not dbData.EOF Then
