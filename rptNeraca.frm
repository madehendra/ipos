...
Begin VB.Form rptNeraca 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports RptNeraca 
         ...
         Sections(0).Cells(1).Name=   "NamaPerusahaan"
         Sections(0).Cells(1).Exp=   "cNamaPerusahaan"
         ...
         Sections(5).Cells.Count=   5
         Sections(5).Cells(0).Name=   "CELL_5"
         Sections(5).Cells(0).Exp=   """ """
         Sections(5).Cells(0).NewLine=   -1  'True
         Sections(5).Cells(0).Height=   10
         Sections(5).Cells(0).AutoHeight=   0   'False
         Sections(5).Cells(1).Name=   "Tempat"
         Sections(5).Cells(1).Exp=   "cTTd"
         ...
         Sections(5).Cells(2).Name=   "CELL_0"
         Sections(5).Cells(2).Exp=   """Mengetahui"""
         Sections(5).Cells(2).NewLine=   -1  'True
         Sections(5).Cells(2).Width=   33
         Sections(5).Cells(3).Name=   "CELL_1"
         Sections(5).Cells(3).Exp=   """Pemeriksa"""
         Sections(5).Cells(3).Width=   33
         Sections(5).Cells(4).Name=   "CELL_2"
         Sections(5).Cells(4).Exp=   """Pembuat"""
