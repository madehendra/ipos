...
Begin VB.Form rptSaldoSimpananWajib 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Saldo Simpanan Wajib"
   ClientHeight    =   1785
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   7710
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptSaldoSimpananWajib.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptSaldoSimpananWajib.frx":00A6
      End
   End
End
Attribute VB_Name = "rptSaldoSimpananWajib"
...
Dim cField As String
  ...
  Set dbData = objData.Browse(GetDSN, "totsimpananwajib t", "t.kodeanggota,a.nama,a.kodedep,a.alamat, sum(t.jumlah) as saldoakhir", "t.tgl", sisLTEqual, Format(dDate.Value, "yyyy-MM-dd"), "GROUP BY t.kodeanggota", , Array("LEFT JOIN anggota a ON a.kodeanggota = t.kodeanggota"))
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      ...
      vaArray(n, 4) = GetNull(dbData!saldoakhir)
      dbData.MoveNext
    Loop
    Rpt
  End If
...
Private Sub Rpt()
  With FrmRPT
    .AddPageHeader "DAFTAR SALDO SIMPANAN WAJIB", tdbHalignCenter, , , , , 10, True
