...
Begin VB.Form rptPPnKeluaran 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPPnKeluaran.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPPnKeluaran.frx":00A6
      End
   End
End
Attribute VB_Name = "rptPPnKeluaran"
...
Dim vaJoin
  ...
  cField = "s.alamat,s.nama,sum(t.pajak) as pajak,s.telp"
  cWhere = " AND t.tgl <= '" & Format(dTgl(1).Value, "yyyy-MM-dd") & "'"
  cWhere = cWhere & " AND t.pajak <> 0 GROUP BY s.kodeanggota"
  vaJoin = Array("LEFT JOIN anggota s on t.kodeanggota = s.kodeanggota")
  Set dbData = objData.Browse(GetDSN, "totpenjualan t", cField, "t.Tgl", sisGTEqual, Format(dTgl(0).Value, "yyyy-MM-dd"), cWhere, "t.tgl,t.nomorpenjualan", vaJoin)
  If Not dbData.EOF Then
    ...
    Do While Not dbData.EOF
      ...
      vaArray(n, 2) = GetNull((dbData!telp), "")
...
Private Sub GetRpt()
  With FrmRPT
    .AddPageHeader "LAPORAN PPn KELUARAN", tdbHalignCenter, , , , dbArial, 12, True
    ...
    .AddTableHeader "NAMA", , , , , , , 10, , , , , , , , False, 8
