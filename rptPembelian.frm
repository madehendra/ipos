...
Begin VB.Form rptPembelian 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports tdb 
         ...
         Sections(0).Cells(2).Exp=   """LAPORAN DETAIL PEMBELIAN"""
         ...
         Sections(5).Cells(14).Exp=   """TOTAL PEMBELIAN"""
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptPembelian.frx":00A6
      End
   End
End
Attribute VB_Name = "rptPembelian"
...
Dim nTotal As Double
  ...
  End If
  cSQL = "SELECT p.nomorpembelian,p.kodesatuan,s.barcode,p.kodestock,p.qty,p.harga,p.discount as disc,p.jumlah,"
  ...
  If Check3.value = 0 Then
    cSQL = cSQL & " FROM pembelian p"
  Else
    cSQL = cSQL & " FROM konsinyasi p"
  End If
  ...
  'Filter lunas
  If optLunas(0).value = 1 Then
    cSQL = cSQL & " and t.flaglunas = '1'"
  End If
  
  If optLunas(1).value = 1 Then
    cSQL = cSQL & " and t.flaglunas = '0'"
  End If
   
  If Check3.value = 1 Then
    cSQL = cSQL & " and t.konsinyasi = 1"
  End If
  
  
  cSQL = cSQL & " AND p.tgl <='" & Format(dDate(1).value, "yyyy-MM-dd") & "'" & cFilter
  cSQL = cSQL & " ORDER BY p.nomorpembelian"
  ...
  If Not dbData.EOF Then
    ...
    Do While Not dbData.EOF
      ...
      vaArray(n, 0) = (dbData!nomorpembelian)
...
Dim cSQL As String
  ...
  If Check2.value = 1 Then
    cSQL = cSQL & " and kodegudang = '" & cGudang.Text & "'"
  End If


  If Check3.value = 1 Then
    cSQL = cSQL & " and konsinyasi = '1'"
  Else
    cSQL = cSQL & " and konsinyasi = '0'"
  End If
