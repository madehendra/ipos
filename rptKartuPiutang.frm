...
Begin VB.Form rptKartuPiutang 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptKartuPiutang.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptKartuPiutang.frx":00A6
      End
   End
End
Attribute VB_Name = "rptKartuPiutang"
...
Private Sub GetData()
  Set vaArray = Getkartupiutang(cKode.Text, dTgl(0).Value, dTgl(1).Value, IIf(optSaldoAwal(0).Value = True, True, False))
  With FrmRPT
    .AddPageHeader aCfg(objData, msNamaPerusahaan), tdbHalignCenter, , , , dbArial, 12, True
    .AddPageHeader "LAPORAN KARTU PIUTANG", tdbHalignCenter, , , True
    .AddPageHeader " ", , , , True
    .AddPageHeader " ", , , , True
    ...
    .AddTableHeader "TANGGAL", , , , 9, , , , , , , , , tdbMergeOnText
    .AddTableHeader "KETERANGAN", , , , , , , , , , , , , tdbMergeOnText
    .AddTableHeader "FAKTUR", , , , 12, , , , , , , , , tdbMergeOnText
    .AddTableHeader "MUTASI", , , , 13, , , , , , , , , , 2
    .AddTableHeader , , , , 13
    .AddTableHeader "SALDO", , , , 14, , , , , , , , , tdbMergeOnText
    .AddTableHeader "GROUP", , , , 9, , , , , , , , , tdbMergeOnText
    ...
    .AddTableHeader "GROUP", , , , , , , , , , , , , tdbMergeOnText
...
Private Sub cNama_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "anggota a", "a.nama,d.keterangan,a.kodeanggota", "a.nama", sisContent, cNama.Text, " or a.kodeanggota like '%" & cNama.Text & "%'", "a.nama", Array("left join dep d on d.kodedep = a.kodedep"))
  'cNama.Text = cNama.Browse(dbData)
  cNama.Text = cNama.Browse(dbData, Array("NAMA", "DEPT", "KODE"), , Array(30, 15, 15))
  If Not dbData.EOF Then
    GetDataanggota
  End If
End Sub
...
Private Sub GetDataanggota()
  ...
  cAlamat.Text = GetNull(dbData!keterangan, "")
End Sub
