...
Public dTglTopUp As String
Public cJenisTopUp As String
...
Dim nItemKatalog As Double
    ...
    vp.StartDoc
      With vp
        ...
        .FontSize = 9
        .FontName = "Tahoma"
        .Text = "BUKTI SETORAN NO. " & noOrder & vbCrLf
        .Text = cJenisTopUp & " Tgl. " & dTglTopUp & vbCrLf
        ...
        Set dbData = objData.Browse(GetDSN, "membertopup m", "m.kodeanggota,a.nama,m.keterangan,m.debet", "m.nomormembertopup", sisAssign, noOrder, , , Array("left join anggota a on a.kodeanggota = m.kodeanggota"))
        If Not dbData.EOF Then
          Do While Not dbData.EOF
            .TextAlign = taJustTop
            .Text = n + 1 & " - [" & GetNull(dbData!kodeanggota) & "] " & GetNull(dbData!nama) & vbCrLf
            .Text = Padl(GetNull(dbData!keterangan), 14) & vbTab & vbTab & " = " & Padr(Format(GetNull(dbData!debet), "###,###,##0"), 15) & vbCrLf
            n = n + 1
        ...
        Garis
          .Text = "Terimakasih sudah melakukan Top Up" & vbCrLf
          .Text = "Simpanlah tanda bukti ini sebagai bukti setoran uang"
      End With
    vp.EndDoc
    MousePointer = 0
End Sub
