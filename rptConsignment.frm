...
Begin VB.Form rptConsignment 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports tdb 
         ...
         Sections(0).Cells(2).Exp=   """LAPORAN DETAIL CONSIGNMENT"""
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptConsignment.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptConsignment.frx":00A6
      End
   End
End
Attribute VB_Name = "rptConsignment"
...
Dim nTotal As Double
  ...
  End If
  cSQL = "SELECT p.nomorkonsinyasi,p.kodesatuan,s.barcode,p.kodestock,p.qty,p.harga,p.discount as disc,p.jumlah,"
  ...
  cSQL = cSQL & " LEFT JOIN totkonsinyasi t on t.nomorkonsinyasi = p.nomorkonsinyasi"
  ...
  cSQL = cSQL & " ORDER BY p.nomorkonsinyasi"
  ...
  If Not dbData.EOF Then
    ...
    Do While Not dbData.EOF
      ...
      vaArray(n, 0) = (dbData!nomorkonsinyasi)
