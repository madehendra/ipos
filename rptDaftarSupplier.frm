...
Begin VB.Form rptDaftarSupplier 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptDaftarSupplier.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptDaftarSupplier.frx":00A6
      End
   End
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(7)=   "Column(1).Width=4683"
      Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=4604"
      ...
      Splits(0)._ColumnProps(19)=   "Column(3).Width=2937"
      Splits(0)._ColumnProps(20)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(21)=   "Column(3)._WidthInPix=2858"
      Splits(0)._ColumnProps(22)=   "Column(3)._EditAlways=0"
      Splits(0)._ColumnProps(23)=   "Column(3)._ColStyle=512"
      Splits(0)._ColumnProps(24)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(25)=   "Column(4).Width=2593"
      Splits(0)._ColumnProps(26)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(27)=   "Column(4)._WidthInPix=2514"
      ...
      _StyleDefs(12)  =   ":id=2,.fontname=Times New Roman"
      ...
      _StyleDefs(23)  =   "Splits(0).CaptionStyle:id=22,.parent=4,.bold=0,.fontsize=825,.italic=0"
      _StyleDefs(24)  =   ":id=22,.underline=0,.strikethrough=0,.charset=0"
      _StyleDefs(25)  =   ":id=22,.fontname=Times New Roman"
   ...
   End
End
Attribute VB_Name = "rptDaftarSupplier"
...
Private Sub cmdPreview_Click()
   With FrmRPT
     .AddPageHeader UCase("Daftar Supplier"), tdbHalignCenter, , , True, dbArial, 12, , , False
     .AddPageHeader aCfg(objData, msNamaPerusahaan), tdbHalignCenter, , , True, , 14
     .AddPageHeader "", , , , True
     .AddPageHeader "", , , , True
     
     .AddTableHeader "KODE", , , , 7
     .AddTableHeader "NAMA", , , , 27
     .AddTableHeader "ALAMAT"
     .AddTableHeader "KOTA", , , , 16
     .AddTableHeader "TELEPON", , , , 12
     .AddTableBody
     .AddTableBody
     .AddTableBody
     .AddTableBody
