...
Begin VB.Form TemplatePenjualan 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":07A6
      End
   End
   Begin BiSAFramProject.BiSAFrame BisaFrame2 
      ...
      Begin BiSAButtonProject.BiSAButton cmdOK 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "TemplatePenjualan.frx":0A2C
      End
   ...
   End
End
Attribute VB_Name = "TemplatePenjualan"
