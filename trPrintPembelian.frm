...
Begin VB.Form trPrintPembelian 
   ...
   End
End
Attribute VB_Name = "trPrintPembelian"
...
Dim nItemKatalog As Double
    ...
    vp.StartDoc
      With vp
        ...
        Set dbData = objData.Browse(GetDSN, "pembelian m", "s.barcode,m.tgl,m.kodestock,s.nama,m.qty,m.harga,m.discount,m.jumlah", "m.nomorpembelian", sisAssign, noOrder, , , Array("left join stock s on s.kodestock = m.kodestock"))
        If Not dbData.EOF Then
          ...
          .FontSize = 9
          .FontName = "Tahoma"
          .Text = "PEMBELIAN NO. " & noOrder & vbCrLf
