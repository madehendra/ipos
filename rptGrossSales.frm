...
Begin VB.Form rptGrossSales 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptGrossSales.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptGrossSales.frx":00A6
      End
   End
End
Attribute VB_Name = "rptGrossSales"
...
Dim n As Integer
  ...
  cSQL = ""
  cSQL = cSQL & " select t.kodesalesman,s.nama,sum(qty*(hb-(hb*(p.discount/100)))) as gross,sum(p.jumlah) as jumlah from penjualan p"
  ...
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      ...
      vaArray(n, 2) = GetNull(dbData!gross)
      vaArray(n, 3) = GetNull(dbData!jumlah)
      vaArray(n, 4) = vaArray(n, 3) - vaArray(n, 2)
      dbData.MoveNext
    Loop
    With FrmRPT
      .AddPageHeader "Gross Omzet Salesman", tdbHalignCenter, , , True, dbArial, 12, True, , , False
      ...
      .AddTableHeader "NAMA"
      .AddTableHeader "GROSS", , , , 20
      .AddTableHeader "OMZET GROSS", , , , 20
      .AddTableHeader "DIFF", , , , 20
