...
Begin VB.Form rptBrowseCustomer 
   ...
   End
End
Attribute VB_Name = "rptBrowseCustomer"
...
Dim n As Integer
  ...
  Set dbData = objData.Browse(GetDSN, "customer", "kodecustomer,nama,alamat,kota,telepon", "kodecustomer", sisContent, TDBGrid1.Columns(0).FilterText, " and nama LIKE '%" & TDBGrid1.Columns(1).FilterText & "%' AND alamat LIKE '%" & TDBGrid1.Columns(2).FilterText & "%' AND kota LIKE '%" & TDBGrid1.Columns(3).FilterText & "%' AND telepon LIKE '%" & TDBGrid1.Columns(4).FilterText & "%'")
  If Not dbData.EOF Then
    Do While Not dbData.EOF
      vaArray.InsertRows vaArray.UpperBound(1) + 1
      n = vaArray.UpperBound(1)
      vaArray(n, 0) = GetNull(dbData!kodecustomer)
