...
Begin VB.Form trCicilanBarang 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cicilan Barang..."
   ClientHeight    =   7380
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   7020
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trCicilanBarang.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trCicilanBarang.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trCicilanBarang.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trCicilanBarang.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trCicilanBarang.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trCicilanBarang.frx":07A6
      End
   End
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin BiSATextBoxProject.BiSABrowse cKodeStock 
         ...
         EndProperty
      End
      Begin BiSATextBoxProject.BiSATextBox cNamaStock 
         Height          =   330
         Left            =   3465
         TabIndex        =   13
         Top             =   1605
         ...
         EndProperty
      End
      Begin BiSATextBoxProject.BiSATextBox cKodeSatuan 
         Height          =   330
         Left            =   2610
         TabIndex        =   15
         Top             =   2235
   ...
   End
End
Attribute VB_Name = "trCicilanBarang"
...
Dim lSave As Boolean
  ...
  If Not db.EOF Then
    ...
    cNamaStock.Text = GetNull(db!nama)
    nQty.Value = GetNull(db!qty)
    nHarga.Value = GetNull(db!Harga)
...
Private Sub cKodeStock_ButtonClick()
  Set dbData = objData.Browse(GetDSN, "stock", "kodestock,nama,kodesatuan,hargajual", "kodestock", sisContent, cKodeStock.Text, , "kodestock")
  If Not dbData.EOF Then
    cKodeStock.Text = cKodeStock.Browse(dbData, Array("Kode", "Nama", "Satuan", "Harga"), , Array(10, 20, 25, 10))
    cNamaStock.Text = GetNull(dbData!nama)
    cKodeSatuan.Text = GetNull(dbData!kodesatuan)
...
lSave = True
  ...
  If isValidSaving Then
    ...
    'Piutang anggota
    '   penjualan
    lSave = IIf(lSave, UpdKodeTr(objData, vbTrigger.msCicilanBarang, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), GetAkunMember(objData, cCustomer.Text), aCfg(objData, msCostCenterJualBeli), "Penjualan Barang an " & cNamaStock.Text, nHarga.Value * nQty.Value, 0, "", SNow), False)
      lSave = IIf(lSave, UpdKodeTr(objData, vbTrigger.msCicilanBarang, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), aCfg(objData, msRekeningPenjualan), aCfg(objData, msCostCenterJualBeli), "Penjualan Barang an " & cNamaStock.Text, 0, nHarga.Value * nQty.Value, "", SNow), False)
    
    'COGS
    '   inventory
    
    lSave = IIf(lSave, UpdKodeTr(objData, vbTrigger.msCicilanBarang, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), aCfg(objData, msRekeningCOGS), aCfg(objData, msCostCenterJualBeli), "COGS Penjualan an " & cNamaStock.Text, nQty.Value * GetHargaPokok(objData, cKodeStock.Text), 0, "", SNow), False)
      lSave = IIf(lSave, UpdKodeTr(objData, vbTrigger.msCicilanBarang, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), GetAkunInventory(objData, cKodeStock.Text), aCfg(objData, msCostCenterJualBeli), "COGS Penjualan an " & cNamaStock.Text, 0, nQty.Value * GetHargaPokok(objData, cKodeStock.Text), "", SNow), False)
...
Private Sub SumCicilan()
  nCicilan.Value = Round(nHarga.Value * nQty.Value / nFrekuensi.Value, 0)
  GetLembarCicilan
End Sub
