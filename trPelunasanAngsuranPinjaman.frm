...
Begin VB.Form trPelunasanAngsuranPinjaman 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pelunasan Angsuran Pinjaman"
   ClientHeight    =   6330
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   9945
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPelunasanAngsuranPinjaman.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdAktivasi 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPelunasanAngsuranPinjaman.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPelunasanAngsuranPinjaman.frx":0429
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPelunasanAngsuranPinjaman.frx":0555
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPelunasanAngsuranPinjaman.frx":0700
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trPelunasanAngsuranPinjaman.frx":07A6
      End
   End
   Begin BiSAFramProject.BiSAFrame BisaFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
         ...
         Columns(1).Caption=   "No Pinjaman"
         Columns(1).DataField=   ""
         Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(2)._VlistStyle=   0
         Columns(2)._MaxComboItems=   5
         Columns(2).Caption=   "Jatuh Tempo"
         Columns(2).DataField=   ""
         Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(3)._VlistStyle=   0
         Columns(3)._MaxComboItems=   5
         Columns(3).Caption=   "Bulan"
         Columns(3).DataField=   ""
         ...
         Columns(5).Caption=   "Pokok"
         Columns(5).DataField=   ""
         Columns(5).NumberFormat=   "###,###,###,##0.00"
         Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(6)._VlistStyle=   0
         Columns(6)._MaxComboItems=   5
         Columns(6).Caption=   "Bunga"
         Columns(6).DataField=   ""
         ...
         Splits(0)._ColumnProps(21)=   "Column(4).Width=1720"
         Splits(0)._ColumnProps(22)=   "Column(4).DividerColor=0"
         Splits(0)._ColumnProps(23)=   "Column(4)._WidthInPix=1640"
         ...
         Splits(0)._ColumnProps(31)=   "Column(6).Width=2514"
         Splits(0)._ColumnProps(32)=   "Column(6).DividerColor=0"
         Splits(0)._ColumnProps(33)=   "Column(6)._WidthInPix=2434"
         Splits(0)._ColumnProps(34)=   "Column(6)._ColStyle=514"
         Splits(0)._ColumnProps(35)=   "Column(6).Order=7"
         Splits(0)._ColumnProps(36)=   "Column(7).Width=1455"
         Splits(0)._ColumnProps(37)=   "Column(7).DividerColor=0"
         Splits(0)._ColumnProps(38)=   "Column(7)._WidthInPix=1376"
         ...
         _StyleDefs(53)  =   "Splits(0).Columns(4).Style:id=46,.parent=13,.alignment=2"
         ...
         _StyleDefs(67)  =   "Splits(0).Columns(7).FooterStyle:id=64,.parent=15,.alignment=1"
      ...
      Begin BiSANumberBoxProject.BiSANumberBox nTotalBunga 
         ...
         EndProperty
      End
      Begin BiSANumberBoxProject.BiSANumberBox nTotalPokok 
         Height          =   330
         Left            =   4800
         TabIndex        =   15
         Top             =   3750
   ...
   End
End
Attribute VB_Name = "trPelunasanAngsuranPinjaman"
...
Dim lSave As Boolean
  ...
  Set dbData = objData.Browse(GetDSN, "totpelunasanpinjaman", "nomorpelunasanpinjaman,kodeakun,jumlah", "kodeanggota", sisAssign, cCustomer.Text)
  If Not dbData.EOF Then
    cFaktur.Text = cFaktur.Browse(dbData)
    cAkunKas.Text = GetNull(dbData!kodeakun)
    nTotalPelunasan.Value = GetNull(dbData!Jumlah)
    Set dbData = objData.Browse(GetDSN, "angsuran c", "c.nomorpinjaman,c.jthtmp,c.bulan,c.tahun,c.pokok,c.bunga,c.jumlah", "c.nomorpelunasanpinjaman", sisAssign, cFaktur.Text, , , Array("LEFT JOIN totpinjaman t on t.nomorpinjaman = c.nomorpinjaman"))
    If Not dbData.EOF Then
      Do While Not dbData.EOF
        vaArray.InsertRows vaArray.UpperBound(1) + 1
        n = vaArray.UpperBound(1)
        vaArray(n, 0) = -1
        vaArray(n, 1) = GetNull(dbData!nomorpinjaman)
        vaArray(n, 2) = Format(GetNull(dbData!JthTmp), "dd/MM/yyyy")
        vaArray(n, 3) = GetNull(dbData!Bulan)
        vaArray(n, 4) = GetNull(dbData!Tahun)
        vaArray(n, 5) = GetNull(dbData!pokok)
    ...
    If nPos = Delete Then
      If MsgBox("Apakah anda yakin data akan dihapus", vbYesNo) = vbYes Then
        ...
        lSave = IIf(lSave, DelKodeTr(objData, msPelunasanPinjaman, cFaktur.Text), False)
        lSave = IIf(lSave, objData.Delete(GetDSN, "totpelunasanpinjaman", "nomorpelunasanpinjaman", sisAssign, cFaktur.Text), False)
        
        'Update status
        'kembalikan status menjadi 0 dan clear kan no pelunasan
        
        For n = vaArray.LowerBound(1) To vaArray.UpperBound(1)
          lSave = IIf(lSave, objData.Edit(GetDSN, "angsuran", " nomorpinjaman = '" & vaArray(n, 1) & "' AND bulan = '" & vaArray(n, 3) & "' AND tahun = '" & vaArray(n, 4) & "'", Array("totpelunasanpinjaman", "lunas"), Array("", "0")), False)
        Next n
...
Private Sub cmdAdd_Click()
  ...
  cFaktur.Text = GetNomor("totpelunasanpinjaman", "nomorpelunasanpinjaman", GetID, SisModulTransaksi.PelunasanPinjaman)
End Sub
...
Dim n As Integer
  ...
  If Not dbData.EOF Then
    ...
    If nPos = Add Then
    Set dbData = objData.Browse(GetDSN, "angsuran c", "c.nomorpinjaman,c.jthtmp,c.bulan,c.tahun,c.pokok,c.bunga,c.jumlah", "t.kodeanggota", sisAssign, cCustomer.Text, " and c.nomorpelunasanpinjaman = ''", "c.tahun,c.bulan asc", Array("LEFT JOIN totpinjaman t on t.nomorpinjaman = c.nomorpinjaman"))
    If Not dbData.EOF Then
      Do While Not dbData.EOF
        vaArray.InsertRows vaArray.UpperBound(1) + 1
        n = vaArray.UpperBound(1)
...
lSave = True
  ...
  If isValidSaving Then
    ...
    lSave = IIf(lSave, objData.Delete(GetDSN, "totpelunasanpinjaman", "nomorpelunasanpinjaman", sisAssign, cFaktur.Text), False)
    lSave = IIf(lSave, objData.Add(GetDSN, "totpelunasanpinjaman", Array("nomorpelunasanpinjaman", "username", "kodeanggota", "kodeakun", "tgl", "jumlah"), Array(cFaktur.Text, GetRegistry(reg_UserName), cCustomer.Text, cAkunKas.Text, Format(dTgl.Value, "yyyy-MM-dd"), nTotalPelunasan.Value)), False)
    'update tabel cicilan
    For n = vaArray.LowerBound(1) To vaArray.UpperBound(1)
      If vaArray(n, 0) = -1 Then
        lSave = IIf(lSave, objData.Edit(GetDSN, "angsuran", " nomorpinjaman = '" & vaArray(n, 1) & "' AND bulan = '" & vaArray(n, 3) & "' AND tahun = '" & vaArray(n, 4) & "'", Array("nomorpelunasanpinjaman", "lunas"), Array(cFaktur.Text, "1")), False)
      Else
        lSave = IIf(lSave, objData.Edit(GetDSN, "angsuran", " nomorpinjaman = '" & vaArray(n, 1) & "' AND bulan = '" & vaArray(n, 3) & "' AND tahun = '" & vaArray(n, 4) & "'", Array("nomorpelunasanpinjaman", "lunas"), Array("", "0")), False)
      End If
    Next n
    ...
    ' Piutang Customer
    lSave = IIf(lSave, DelKodeTr(objData, msPelunasanPinjaman, cFaktur.Text), False)
    lSave = IIf(lSave, UpdKodeTr(objData, msPelunasanPinjaman, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), cAkunKas.Text, aCfg(objData, msCostCenterSimpanPinjam), "Pelunasan Pinjaman", nTotalPelunasan.Value, 0, "K", SNow), False)
      lSave = IIf(lSave, UpdKodeTr(objData, msPelunasanPinjaman, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), aCfg(objData, msRekeningPinjaman), aCfg(objData, msCostCenterSimpanPinjam), "Pelunasan Pinjaman", 0, nTotalPokok.Value, "K", SNow), False)
      lSave = IIf(lSave, UpdKodeTr(objData, msPelunasanPinjaman, cFaktur.Text, Format(dTgl.Value, "yyyy-MM-dd"), aCfg(objData, msRekeningPendapatanBungaPinjaman), aCfg(objData, msCostCenterSimpanPinjam), "Pelunasan Pinjaman", 0, nTotalBunga.Value, "K", SNow), False)
...
Dim nTmpBunga
  ...
  For n = vaArray.LowerBound(1) To vaArray.UpperBound(1)
    If vaArray(n, 0) = -1 Then
      nTmpTotal = nTmpTotal + vaArray(n, 7)
      nTmpPokok = nTmpPokok + vaArray(n, 6)
      nTmpBunga = nTmpBunga + vaArray(n, 5)
    End If
  Next n
  nTotalPelunasan.Value = nTmpTotal
  nTotalPokok.Value = nTmpPokok
  nTotalBunga.Value = nTmpBunga
End Sub
